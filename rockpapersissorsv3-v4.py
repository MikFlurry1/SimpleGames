...
# Main game loop
while PlayerScore < 300 and ComputerScore < 300:
    ...
    elif (ComputerAnswer == "rock" and PlayerAnswer == "paper") or \
         (ComputerAnswer == "paper" and PlayerAnswer == "sissors") or \
         (ComputerAnswer == "sissors" and PlayerAnswer == "rock"):
